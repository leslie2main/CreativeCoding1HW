...
let shapes = []; // Array for shape objects
...
function setup() {
  ...
  // Create shape objects and store in array
  shapes.push(new SimpleShape(100, 100, 40, 40, color(255, 0, 0)));
  shapes.push(new SimpleShape(300, 200, 60, 30, color(0, 255, 0)));
  shapes.push(new SimpleShape(500, 350, 50, 50, color(0, 0, 255)));
}
...
function draw() {
  ...
  // Draw shape objects from the class
...
function mousePressed() {
  // Add a new moving obstacle at mouse location
  obstacles.push({
    x: mouseX,
    y: mouseY,
    w: random(20, 60),
